...
public class TestDataBuilder {
  ...
  public static PostRider buildPostRiderRequest(
      Long riderId, String pickUpStation, String destinationPlace, Timestamp arrivalTime) {
  ...
  public static RiderRequestDriverEvent buildRiderRequestDriverEvent(
      Long riderId, String pickUpStation, String destinationPlace, Timestamp arrivalTime) {
