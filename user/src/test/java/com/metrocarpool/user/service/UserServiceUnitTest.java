...
class UserServiceUnitTest {
  ...
  void riderSignUp_SavesAndReturnsRider() {
    ...
    RiderEntity savedRider =
        RiderEntity.builder().id(1L).username(username).password(password).build();
  ...
  void riderLogin_ReturnsRider_WhenCredentialsCorrect() {
    ...
    RiderEntity rider = RiderEntity.builder().id(1L).username(username).password(password).build();
