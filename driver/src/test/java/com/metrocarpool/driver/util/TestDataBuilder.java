...
public class TestDataBuilder {
  ...
  public static PostDriver buildPostDriverRequest(
      Long driverId, List<String> route, String destination, Integer seats) {
  ...
  public static DriverRiderMatchEvent buildDriverRiderMatchEvent(
      Long driverId, Long riderId, String pickupStation) {
  ...
  public static DriverLocationEvent buildDriverLocationEvent(
      Long driverId,
      String oldStation,
      String nextStation,
      int timeToNext,
